                            ...
                            .then(data => {
                                ...
                                for (let num = 0; num < infos.length; num++) {
                                    ...
                                    if (info.payLaterRate) {
                                        ...
                                        countNum = countNum + 1;
                                        // csvRow[num] = {'Code': searchKey, 'Name': carName, 'Type': carDesc, 'From':startDate, 'To':endDate, 'PayLater': payLaterAmount, 'PayLaterTotal': payLaterTotalAmount, 'State': state, 'City': city, 'Full Location': fullLocation, 'URL': link}
                                        ...
                                        const fields = ['Code', 'Name', 'Type', 'From', 'To', 'PayLater', 'PayLaterTotal', 'State', 'City', 'Full Location', 'URL']
                                        ...
                                        fs.stat(resultFileName, function (err, stat) {
                                            if (err == null) {
                                              ...
                                              // var csv = json2csv(toCsv) + newLine;
                                                ...
                                                fs.writeFile(resultFileName, fields+newLine, function (err) {
                                                    if (err) throw err;
